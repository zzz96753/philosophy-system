...
% ---------- 字体（霞鹜文楷 Medium 求黑实；AutoFakeBold 保留加粗对比）----------
\setCJKmainfont{LXGW WenKai Medium}[AutoFakeBold=2.5]
\setCJKsansfont{LXGW WenKai Medium}[AutoFakeBold=2.5]
\setCJKmonofont{LXGW WenKai Medium}
\newCJKfontfamily\hei{LXGW WenKai Medium}[AutoFakeBold=3]
\newCJKfontfamily\notolight{LXGW WenKai Light}
% 让中英文引号、破折号归为 CJK 类，用文楷渲染成全角（修引号变西文的问题）
\xeCJKDeclareCharClass{CJK}{"2018, "2019, "201C, "201D, "2014, "2026}
...
% ---------- 章节样式（颜色放在 name/titleformat 里，避免漏入正文）----------
\ctexset{
  chapter/format = \raggedright\hei\bfseries,
  chapter/nameformat = \Large\color{accent},
  chapter/titleformat = \Huge\color{accent},
  chapter/aftername = \\[0.3em],
  chapter/afterskip = 2.4ex,
  section/format = \large\hei\bfseries,
  section/nameformat = \color{ink},
  section/titleformat = \color{ink},
  subsection/format = \hei\bfseries,
  subsection/nameformat = \color{ink},
  subsection/titleformat = \color{ink},
}
\AtBeginDocument{\color{black}}  % 正文默认纯黑
