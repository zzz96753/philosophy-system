...
% ---------- 字体（霞鹜文楷 / 温润书卷气：正文Regular·标题Medium·轻字Light）----------
\setCJKmainfont{LXGW WenKai}[BoldFont={LXGW WenKai Medium}]
\setCJKsansfont{LXGW WenKai}
\newCJKfontfamily\hei{LXGW WenKai}[BoldFont={LXGW WenKai Medium}]
...
陈述式的总览图画的是“谁属于哪一类”。深度思考需要另一张图：\keyq{谁反驳谁、谁回应谁}——思想作为一张动态的论辩网络。\textbf{下页横置展开}（实线 = 反驳/回应，虚线 = 汇入“我的综合立场”）。

\begin{landscape}
\thispagestyle{empty}
\vspace*{\fill}
\begin{center}
\includegraphics[width=\linewidth]{img/tension-map.pdf}\\[1.2em]
{\notolight\small\color{notebar} 思维问题的论辩张力网络　·　四源（计算表征论 / 维特根斯坦 / 佛教唯识 / 庄子）各自发难，经中文房间、接地、how-vs-that 等交锋，汇入综合立场}
\end{center}
\vspace*{\fill}
\end{landscape}
