...
\newCJKfontfamily\notomed{LXGW WenKai Medium}
% 引号/破折号/省略号归 CJK 类，用文楷渲染成全角
...
\ctexset{
  ...
  section/titleformat = \color{accent},
  section/beforeskip = 2.2ex,
  section/afterskip = 1.2ex,
  subsection/format = \large\hei\bfseries,
...
{\LARGE\notolight\color{accent} 一场跨越 2500 年的对话}\\[1.1cm]
{\color{rule}\rule{0.5\textwidth}{0.8pt}}\\[2.2cm]
{\large\notolight\color{ink!80} 人能认识世界吗？人该怎样活？\\[0.4em]
...
\begin{center}
\vspace{0.6em}
{\notomed\color{accent}\Large 故事讲完了。现在，轮到你了。}
\vspace{0.4em}
\end{center}
